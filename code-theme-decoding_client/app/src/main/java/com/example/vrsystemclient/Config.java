...
public class Config {
    ...
    public static String SERVER_IP = "192.168.0.235";
...
//    public final static int[] avaQuality = {15,17,18,22,26,31,35,39};
    //4k
//    public final static int qualityLevel = 10;
//    public final static int[] avaQuality = {15,17,19,21,23,27,32,37,41,45};
...
//    public final static int FRAME_HEIGHT = 1440;
    //4K
//    public final static int FRAME_WIDTH = 3840;
//    public final static int FRAME_HEIGHT = 2160;
    ...
    public final static int FPS_CAL_INTERVAL = TARGET_FPS;
