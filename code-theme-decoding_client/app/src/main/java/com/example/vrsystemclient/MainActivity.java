...
//        traceInput = getResources().openRawResource(R.raw.officetrace);  //轨迹
        traceInput = getResources().openRawResource(R.raw.testtrace_1mins);  //缩短的轨迹
    ...
    private void readIDTable() {
        try{
            InputStream inputStream = getResources().openRawResource(R.raw.id2pose_1080p_264); //修改
//            InputStream inputStream = getResources().openRawResource(R.raw.id2pose_2k_264); //修改
//            InputStream inputStream = getResources().openRawResource(R.raw.id2pose_4k_264); //修改
    ...
    public void readTileTable(){
        try{
            InputStream inputStream = getResources().openRawResource(R.raw.tile_table_1row_4col);//分片
            BufferedReader br = new BufferedReader(new InputStreamReader(inputStream));
