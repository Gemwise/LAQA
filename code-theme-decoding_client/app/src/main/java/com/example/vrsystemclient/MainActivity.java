...
public class MainActivity extends Activity {
    ...
    private void readIDTable() {
        try{
            InputStream inputStream = getResources().openRawResource(R.raw.id2pose_1080p_264); 
//            InputStream inputStream = getResources().openRawResource(R.raw.id2pose_2k_264); 
//            InputStream inputStream = getResources().openRawResource(R.raw.id2pose_4k_264); 
