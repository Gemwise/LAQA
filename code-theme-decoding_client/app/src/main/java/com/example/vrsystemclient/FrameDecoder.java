...
//            Long ts_be = System.currentTimeMillis();
//            System.out.println("decoder start for" + vb.getVideoID() +"ts: "+ ts_be);
            ...
            if (!inputDone) {
                ...
                if (inputBufIndex >= 0) {
                    ...
                    // copy one frame from vb and write into inputBuf, some tiles -> one frame
            ...
            if (!outputDone) {
                ...
                if (decoderStatus >= 0) {
                    ...
                    if ((info.flags & MediaCodec.BUFFER_FLAG_END_OF_STREAM) != 0) {
                        ...
                        int quality = Utils.getQuality(videoID);
                        Long latency = end - first;
//                        System.out.println(quality+"waste"+latency);
                        Stats.decodeTime.add(new Stats.valueOfdecodeTime(latency,quality,String.valueOf(videoID)));
