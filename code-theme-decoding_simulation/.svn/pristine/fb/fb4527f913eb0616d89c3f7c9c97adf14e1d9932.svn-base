...
os.chdir("E:/lyq/02-myWork/01-ICCC/ICCC_CODES/simulation/draw/decode")
input_file = "./1080p_265_decode_nanotime.csv"
data_265 = []
...
input_file = "./1080p_264_decode_nanotime.csv"
data_264 = []
with open(input_file, "r") as f:
    csv_reader = csv.reader(f)
    for row in csv_reader:
...
input_file = "./2k_264_decode_nanotime.csv"
data_264_2k = []
with open(input_file, "r") as f:
    csv_reader = csv.reader(f)
    for row in csv_reader:
...
input_file = "./2k_265_decode_nanotime.csv"
data_265_2k = []
with open(input_file, "r") as f:
    csv_reader = csv.reader(f)
    for row in csv_reader:
...
input_file = "./4k_264_decode_nanotime.csv"
data_264_4k = []
with open(input_file, "r") as f:
    csv_reader = csv.reader(f)
    for row in csv_reader:
...
input_file = "./4k_265_decode_nanotime.csv"
data_265_4k = []
with open(input_file, "r") as f:
    csv_reader = csv.reader(f)
    for row in csv_reader:
...
with plt.style.context(['science','grid','ieee']):
    ...
    # cdf(data_265_2k,"4k H.265","red")
    cdf(data_264_4k,"2k H.264","blue")
    cdf(data_265_4k,"4k H.265","blue")
    plt.autoscale(tight = True)
    plt.legend()
    plt.savefig('./decode_time_4k.pdf',format='pdf',dpi=300,bbox_inches='tight')
